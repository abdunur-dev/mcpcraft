            ...
            <div className="mx-auto max-w-5xl grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 divide-x-0 sm:divide-x divide-white/10 text-center font-mono">
              ...
              <div className="py-6">
                <div className="text-xs text-white/60">GitHub</div>
                 <a href="https://github.com/abdunur-dev/mcpcraft" target="_blank" rel="noreferrer" className="text-sm text-white mt-0.5 hover:underline inline-flex items-center justify-center gap-1.5 max-w-full">
                  ...
                  <span className="truncate">abdunur-dev/mcpcraft</span>
                </a>
              </div>
            </div>
          </section>
