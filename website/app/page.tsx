          ...
          <section className="border-y border-white/10">
            <div className="mx-auto max-w-5xl grid grid-cols-2 sm:grid-cols-3 divide-x divide-white/10 text-center font-mono">
              ...
              <div className="py-6">
                ...
                <a href="https://github.com/abdunur-dev/mcpcraft" target="_blank" rel="noreferrer" className="text-sm text-white mt-0.5 hover:underline inline-flex items-center gap-1.5">
