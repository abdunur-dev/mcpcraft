// @ts-nocheck
import * as __fd_glob_9 from "../content/docs/examples/gmail-server.mdx?collection=docs"
import * as __fd_glob_8 from "../content/docs/examples/basic-server.mdx?collection=docs"
import * as __fd_glob_7 from "../content/docs/api/tool.mdx?collection=docs"
import * as __fd_glob_6 from "../content/docs/api/resource.mdx?collection=docs"
